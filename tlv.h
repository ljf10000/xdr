...
#define xtlv_mapper_fixed(_mapper, _id, _name, _obj) \
    _mapper(_name, _id,  XTLV_T_##_obj, XTLV_F_FIXED, 0, sizeof(xtlv_##_obj##_t), xtlv_dump_##_obj, NULL, NULL)
#define xtlv_mapper_dynamic(_mapper, _id, _name, _obj) \
    _mapper(_name, _id,  XTLV_T_##_obj, 0, 0, 0, xtlv_dump_##_obj, NULL, NULL)
...
#define XTLV_MAPPER(_) \
    ...
    _(ftp_response_delay,   34, XTLV_T_time,    XTLV_F_FIXED, 0, sizeof(xtlv_time_t), xtlv_dump_time, NULL, NULL) \
    _(ftp_trans_time,       35, XTLV_T_time,    XTLV_F_FIXED, 0, sizeof(xtlv_time_t), xtlv_dump_time, NULL, NULL) \
