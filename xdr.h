...
static inline int
to_xdr_session_state(xbuffer_t *x, struct tlv *tlv)
{
    return to_xdr_by(x, tlv, session_state, u8);
}

static inline int
to_xdr_appid(xbuffer_t *x, struct tlv *tlv)
{
    return to_xdr_by(x, tlv, appid, u8);
}

static inline int
to_xdr_session(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_session_st(xbuffer_t *x, struct tlv *tlv)
{
    return to_xdr_obj(x, tlv, session_st);
}

static inline int
to_xdr_service_st(xbuffer_t *x, struct tlv *tlv)
{
    return to_xdr_obj(x, tlv, service_st);
}

static inline int
to_xdr_session_time(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_tcp(xbuffer_t *x, struct tlv *tlv)
{
    return to_xdr_obj(x, tlv, tcp);
}

static inline int
to_xdr_first_response_delay(xbuffer_t *x, struct tlv *tlv)
{
    return to_xdr_by(x, tlv, first_response_delay, u32);
}

static inline int
to_xdr_L7(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_ftp_trans_type(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_ftp_filename(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_ftp(x)->filename, tlv);
}

static inline int
to_xdr_ftp_filesize(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_ftp_response_delay(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_ftp_trans_duration(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_mail_msg_type(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_mail_status_code(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_mail_user(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_mail(x)->user, tlv);
}

static inline int
to_xdr_mail_sender(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_mail(x)->sender, tlv);
}

static inline int
to_xdr_mail_length(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_mail_domain(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_mail(x)->domain, tlv);
}

static inline int
to_xdr_mail_recver(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_mail(x)->recver, tlv);
}

static inline int
to_xdr_mail_hdr(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_mail(x)->hdr, tlv);
}

static inline int
to_xdr_mail_acs_type(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_domain(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_string_ex(x, &xb_pre_dns(x)->domain, tlv);
}

static inline int
to_xdr_dns_ip_count(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_ip4(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_ip6(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_response_code(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_count_request(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_count_response_record(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_count_response_auth(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_count_response_extra(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns_delay(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_http_request(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_file_ex(x, &xb_pre_http(x)->offsetof_request, tlv);
}

static inline int
to_xdr_http_response(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_file_ex(x, &xb_pre_http(x)->offsetof_response, tlv);
}

static inline int
to_xdr_file_content(xbuffer_t *x, struct tlv *tlv)
{
    return xb_pre_file_ex(x, &x->u.xdr->offsetof_file_content, tlv);
}

static inline int
to_xdr_ssl_server_cert(xbuffer_t *x, struct tlv *tlv)
{
    return 0; // do nothing
}

static inline int
to_xdr_ssl_client_cert(xbuffer_t *x, struct tlv *tlv)
{
    return 0; // do nothing
}

static inline int
to_xdr_ssl_fail_reason(xbuffer_t *x, struct tlv *tlv)
{
...
static inline int
to_xdr_dns(tlv_record_t *r, xbuffer_t *x)
{
...
static inline int
to_xdr_ssl_helper(tlv_record_t *r, xbuffer_t *x, xdr_array_t *certs, int id)
{
    tlv_cache_t *cache = &r->cache[id];
    if (0==cache->count) {
        return 0;
...
static inline int
to_xdr_ssl(tlv_record_t *r, xbuffer_t *x)
{
...
static inline int
to_xdr_helper(tlv_cache_t *cache, xbuffer_t *x)
{
    tlv_ops_t *ops;
    struct tlv *tlv;
    int i, err;
...
static inline int
to_xdr(tlv_record_t *r, xbuffer_t *x)
{
    int i, err;
